...
fn main() {
    ...
    println!(
        "  Generated absence proof with {} siblings",
        absence_proof.siblings.len()
    );
    ...
    println!(
        "  Generated presence proof with {} siblings",
        presence_proof.siblings.len()
    );
    ...
    println!(
        "Before insertion: charlie absence proof valid = {:?}",
    ...
    println!(
        "After insertion (old root): charlie absence proof valid = {:?}",
        AbsenceStore::verify_absent(&charlie_absence, &old_root).is_ok()
    );

    // Old proof INVALID against NEW root
    println!(
        "After insertion (new root): charlie absence proof valid = {:?}",
